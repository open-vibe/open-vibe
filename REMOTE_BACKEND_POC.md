...
This fork includes a **proof-of-concept** daemon that runs Open Vibe's backend logic in a separate process (intended for WSL2/Linux), exposing a simple **line-delimited JSON-RPC** protocol over TCP.
