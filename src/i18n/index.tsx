...
const en = {
  ...
  "threadTabs.menu.openInWindow": "Move to new window",
  ...
  "threadTabs.detached.empty": "Tab is not available in this window.",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "threadTabs.menu.openInWindow": "移到新窗口",
  ...
  "threadTabs.detached.empty": "此窗口中的标签不可用。",
